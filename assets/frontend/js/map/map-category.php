   ...
   //fullscreen ends
    ...
    $(document).ready(function(){
        ...
        $.getJSON(settings.jsonFile).done(function (json) {
             ...
             fin_lat= json.features[0].geometry.coordinates[1];
            fin_lon= json.features[0].geometry.coordinates[0];
            var getPosition = {
            ...
            function success(gotPosition,e) {
                var uLat = gotPosition.coords.latitude;
                var uLon = gotPosition.coords.longitude;
                //    console.log(<?= get_settings("default_location"); ?>);
                L.Routing.control({
                    waypoints: [
                        L.latLng(uLat, uLon),
                        L.latLng(fin_lat,fin_lon)
                    ]
                }).addTo(map);
