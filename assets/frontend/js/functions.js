(function ($) {
	...
	$(window).on('scroll', function () {
		if ($(this).scrollTop() > 1) {
			...
			$('.tagline').removeClass("mark81");
			$('.tagline').removeClass("tagline-color");
			$('.tagline').addClass("mark8");
			// document.getElementById("tagline-info").style.color = "white";
		} else {
			$('.header').removeClass("sticky");
			$('.tagline').removeClass("mark8");
			$('.tagline').removeClass("tagline-color");
			$('.tagline').addClass("mark81");
		}
	});
