...
class User_model extends CI_Model {
    ...
    //dchange user online check
    function edit_user_online($user_id,$online) {
            $data['online'] = sanitizer($online);
            $this->db->where('id', $user_id);
    ...
    //dchange ends
      ...
      //google add_user
    function add_google_user($name,$email,$picture) {
        ...
        if($validity){
                ...
                $user_id = $this->db->insert_id();
            $url = $picture;
            $img = 'uploads/user_image/'.$user_id.'.jpg';
