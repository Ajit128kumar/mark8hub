...
<h5 class="abt-titl add_bottom_15"><?php echo get_phrase('hotel_room_details'); ?></h5>
	...
	<div class="room_type first">
		<div class="row">
			...
			<div class="col-md-8">
				...
				<p class="price_ht_room" style="margin-bottom: 10px;"><?php echo get_phrase('price').': '.currency($hotel_room['price']); ?></p>
			</div>
		</div>
	</div>
<?php endforeach; ?>
