				...
				<form action="<?php echo site_url('home/search'); ?>" method="GET">
					<div class="row no-gutters custom-search-input-2 inner">
						...
						<div class="col-lg-3">
						   ...
						   <div class="col-lg-3">
                            <select class="wide select2"  name="selected_city_id">
                                <option value=""><?php echo get_phrase('all_cities'); ?></option>
                                <?php
                                $cites = $this->crud_model->get_cities_by_country_id(151)->result_array();
		...
		<div class="col-xl-5 col-md-12 order-xl-1 order-2" id="listings">
			<!-- This view -->
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 listing-div alignment-card" data-marker-id="<?php echo $listing['code']; ?>" id = "<?php echo $listing['code']; ?>">
						<div class="strip grid featured_product_show <?php if($listing['is_featured'] == 1) echo 'featured-tag-border'; ?>">
							<figure>
