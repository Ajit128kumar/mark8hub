<nav id="menu" class="main-menu d-flex align-items-center">
    <ul>
        <form action="<?php echo site_url('home/searchHome'); ?>" method="get">
            <input type="text" name="search_string" class="search" placeholder="Search..">
        </form>    
