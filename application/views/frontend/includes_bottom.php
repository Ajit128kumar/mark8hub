...
<script>
	$(document).ready(function(){
	  ...
	  $('.thumb').on('click',function(){
            var vm = this;
            $("#xzoom-magnific").fadeOut(600,function(){
				var d = new Date();
                var src = $(vm).attr("src");
                $("#xzoom-magnific").attr({src:"http://localhost/Mark8Hub/uploads/shop/bea31ddfd934cc231baf1fb30759c46b.jpg"}).fadeIn(1000);
                console.log($("#xzoom-magnific"));
            });
            // return false;
