...
?>
<section id="reviews">
  <h5 class="abt-titl add_bottom_15"><?php echo get_phrase('reviews'); ?></h2>
    <!-- Ratings starts -->
  ...
  <?php if($user_type == 2){ ?>
   <!--  <hr> -->
    ...
    <div class="add-review rev__" id="claim_user">
      <h5 class="abt-titl add_bottom_15"><?php echo get_phrase('leave_a_review'); ?></h5>
          ...
          <div class="form-group col-md-12 add_top_20 add_bottom_30">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-6 col-sm-6">
                ...
                <div class="rv_btn_">
                  <small style="float: right;" class="mt-2"><a style="background-color: #ffc107; color: #212529;"href='javascript::' <?php if ($this->session->userdata('user_login') == 1):?> onclick="showReportForm();" <?php else: ?> onclick="loginAlert()" <?php endif; ?> style="color: #616161;"> <?php echo get_phrase('report_this_listing'); ?> </a></small>
                </div>
              </div>
            </div>
          </div>
...
<div class="" id = "claim_form" style="display: none;">
  ...
  <form action="<?php echo site_url('home/claim_this_listing'); ?>" method="post" enctype="multipart/form-data" >
    <input type="hidden" name="listing_id" value="<?php echo $listing_id; ?>">
    ...
    <div class="row">
      ...
      <div class="form-group col-md-12">
        <label for="pan">PAN certificate photo </label><br>
