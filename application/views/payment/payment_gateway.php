<style>
	...
	.paypal-form, .stripe-form, .esewa-form{
		display: none;
	}
			...
			<div class="row">
				<div class="col-md-3">
					...
					<?php if ($paypal[0]->active != 0): ?>
						...
						<div class="row payment-gateway esewa" onclick="selectedPaymentGateway('esewa')">
							<div class="col-12">
								<img class="tick-icon esewa-icon" src="<?php echo base_url('assets/payment/tick.png'); ?>">
								<img class="payment-gateway-icon" src="<?php echo base_url('assets/payment/esewa.png'); ?>">
							</div>
				...
				<div class="col-md-8">
					...
					<div class="w-100 float-left">
			            ...
			            <form action="https://uat.esewa.com.np/epay/main" method="POST" class="esewa-form form">
                            <input value="<?= $total_price_of_checking_out; ?>" name="tAmt" type="hidden">
                            <input value="<?= $total_price_of_checking_out ?>" name="amt" type="hidden">
                            <input value="0" name="txAmt" type="hidden">
                            <input value="0" name="psc" type="hidden">
                            <input value="0" name="pdc" type="hidden">
                            <input value="EPAYTEST" name="scd" type="hidden">
                            <input value="ES-2109061126" name="pid" type="hidden">
                            <input value="http://merchant.com.np/page/esewa_payment_success?q=su" type="hidden" name="su">
                            <input value="http://merchant.com.np/page/esewa_payment_failed?q=fu" type="hidden" name="fu">
                            <!--<input value="Submit" type="submit">-->
                            <button type="submit" class="payment-button float-right">Pay by esewa</button>
			            </form>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	function selectedPaymentGateway(gateway){
		if(gateway == 'paypal'){
			...
			$(".esewa").css("border","2px solid #00D04F");
			$('.esewa-icon').show();
			$('.esewa-form').show();
		}
	}
