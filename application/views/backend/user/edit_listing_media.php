<div class="form-group">
    <label class="col-sm-3 control-label">PAN Certificate Photo<br> (For verification) <br/>  </label>
    <div class="col-sm-7">
        <div class="fileinput fileinput-new" data-provides="fileinput">
            <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
                <img src="<?php echo base_url('uploads/pan/'.$listing_details['pan']); ?>" alt="...">
            </div>
...
<div class="form-group">
    <label class="col-sm-3 control-label"> Business logo <br/>  </label>
    <div class="col-sm-7">
        <div class="fileinput fileinput-new" data-provides="fileinput">
            <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
                <img src="<?php echo base_url('uploads/logo/'.$listing_details['logo']); ?>" alt="...">
            </div>
            <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px"></div>
            <div>
        <span class="btn btn-white btn-file">
