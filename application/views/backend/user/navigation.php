<div class="sidebar-menu">
	<header class="logo-env" >
		...
		<div class="sidebar-mobile-menu visible-xs" >
			<a href="#" class="with-animation" style="padding-left:6px;">Menu
				<i class="entypo-menu"></i>
			</a>
		</div>
	</header>
  ...
  <!--new -->
        <!--<li class="<?php if ($page_name == 'listings_update_ps') echo 'active'; ?>">-->
        <!--    <a href="<?php echo site_url('user/update_listings_ps'); ?>">-->
        <!--        <i class="fa fa-object-group"></i>-->
        <!--        <span>Offers and menus</span>-->
        <!--    </a>-->
        <!--</li>-->

        <li class="<?php if ($page_name == 'manage_products') echo 'active'; ?>">
            <a href="<?php echo site_url('user/manage_products'); ?>">
                <i class="fa fa-infinity"></i>
                <span>Products</span>
            </a>
        </li>
        
        <li class="<?php if ($page_name == 'listings_update_ss') echo 'active'; ?>">
            <a href="<?php echo site_url('user/update_listings_ss'); ?>">
                <i class="fa fa-infinity"></i>
                <span>Services</span>
            </a>
        </li>

        <li class="<?php if ($page_name == 'listings_update_gallery') echo 'active'; ?>">
            <a href="<?php echo site_url('user/update_listings_gallery'); ?>">
                <i class="fa fa-images"></i>
                <span>Gallery</span>
            </a>
        </li>
        <li class="<?php if ($page_name == 'manage_branches') echo 'active'; ?>">
            <a href="<?php echo site_url('user/manage_branches'); ?>">
                <i class="fa fa-code-branch"></i>
                <span>Branch</span>
            </a>
        </li>
        <li class="<?php if ($page_name == 'manage_achievements') echo 'active'; ?>">
            <a href="<?php echo site_url('user/manage_achievements'); ?>">
                <i class="fa fa-code-branch"></i>
                <span>Achievements</span>
            </a>
        </li>
        <!--<li class="<?php if ($page_name == 'listings_update_brand') echo 'active'; ?>">-->
        <!--    <a href="<?php echo site_url('user/update_listings_brand'); ?>">-->
        <!--        <i class="fa fa-object-ungroup"></i>-->
        <!--        <span>Brands we deal</span>-->
        <!--    </a>-->
        <!--</li>-->
	...
	<!-- Manage Profile -->
		...
		<!--			</a>-->
		<!--		</li>-->
		<!--		<li class="<?php if ($page_name == 'booking_request_service') echo 'active'; ?> ">-->
		<!--			<a href="<?php echo site_url('user/booking_request_service'); ?>">-->
		<!--				<span><i class="entypo-dot"></i> Service</span>-->
		<!--			</a>-->
		<!--		</li>-->
		<!--	</ul>-->
		<!--</li>-->
