...
<div class="alert alert-warning text-center " style="font-weight:bold; color:red;" role="alert">
  Please Select a Package from Dashboard <code class="text-uppercase" style="color:black;">" Menu "</code>, by clicking upon <code class="text-uppercase" style="color:black;">" Pricing "</code>. And get started to register your business.
</div>
<div class="row">
  <div class="col-lg-6">
    <div class="row">
