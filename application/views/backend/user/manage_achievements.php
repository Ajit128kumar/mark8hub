	...
	<div class="col-lg-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                <div class="col-md-12">
                <form action="<?= base_url() ?>user/manage_achievements" method="post">
...
<!--                             <th> <input type="submit" class="btn btn-success" value="search" name="submit"></th> -->
                  ...
                  <!-- <div id="viewall-data">
          				...
          				<form action="<?= base_url() ?>user/update_achievements" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered listing_edit_form">
          				<div class="col-md-12">
                    ...
                    <div id="viewall-data">
                      ...
                      <?php //include 'edit_achievements.php'; ?>
                        <div class="text-center">
                            <br>
                             <input type="hidden" name="listing_id_update" id="listing_id_update" value="<?= $listing_id ?>">

                             
                            <input type="submit" style="display: none;" class="btn btn-primary acheivement_button" name="submit_update"  value="<?php echo get_phrase('submit'); ?>" onclick="this.form.submit()" >
                        </div>
  ...
  $('select[name="listing_id"]').change(function(){
      ...
      $.ajax({
          type: "POST",
          url: "<?php echo base_url('User/getTheAchievementsData');?>",
          ...
          success: function(data){
            ...
            $('#listing_id_update').val(listing_id);
            $('.acheivement_button').show();
