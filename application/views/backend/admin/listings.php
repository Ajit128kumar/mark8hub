        ...
        <table class="table table-bordered" id="example1">
          <thead>
            <tr>
              ...
              <th><div>Business Type</div></th>
              <th><div><?php echo get_phrase('location');?></div></th>
                <th><div>PAN Certificate</div></th>
          ...
          <tbody id = "listing_table">
            ...
            foreach ($listings as $listing):
               //new
                ...
                {
                    $parent_listing = $this->crud_model->get_listings($listing['parent_id'])->row_array();
            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <td>
                      <?php
                      if(!empty($listing['pan']))
                      {
                          ?>
                          <a target="_blank" href="<?php echo base_url('uploads/pan/'.$listing['pan']); ?>">
                              <img src="<?php echo base_url('uploads/pan/'.$listing['pan']); ?>" width="70" height="80" />
                          </a>
                          <?php
                      } else {
                          ?>
                          <img src="<?php echo base_url('uploads/placeholder.png'); ?>" width="70" height="80" />
                          <?php
                      }
                      ?>
                  ...
                  <div class="bs-example">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-blue" role="menu">
                        ...
                        <?php endif; ?>
                          <li><a href="<?php echo site_url('admin/listing_form/add/'.$listing['id']); ?>">Add Branches</a></li>
