...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" name="linkedin" placeholder="www.instagram.com/xyz/" aria-label="instagram" aria-describedby="basic-addon-linkedin" value="<?php echo $social_links['linkedin']; ?>">
  </div>
</div>
