...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" name="facebook" placeholder="www.facebook.com/xyz/">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" name="twitter" placeholder="www.twitter.com/xyz/">
  </div>
</div>
<div class="form-group">
  <label class="col-sm-3 control-label" for="Instagram"><?php echo get_phrase('linkedin'); ?></label>
  <div class="col-sm-7">
    <input type="text" class="form-control" name="linkedin" placeholder="www.instagram.com/xyz/">
  </div>
</div>
<!--next button-->
<div class="row col-12" style="text-align:end;">
    <!--<button class="btn btn-success">Next</button>-->
     <a class="btn btn-success btn-lg" onclick="$('#ninth_finish').trigger('click')">Next</a>
</div>
