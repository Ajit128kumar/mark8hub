            ...
            <tr>
              ...
              <td>
                ...
                <?php echo $claimed_listing['additional_information']; ?>
                 ...
                 <td>
                    <?php
                    if(!empty($claimed_listing['pan']))
                    {
                        ?>
                        <a target="_blank" href="<?php echo base_url('uploads/claimed_pan/'.$claimed_listing['pan']); ?>">
                            <img src="<?php echo base_url('uploads/claimed_pan/'.$claimed_listing['pan']); ?>" width="70" height="80" />
                        </a>
                        <?php
                    } else {
                        ?>
