...
<!--  <div class="col-sm-7">-->
<!--    <select name="country_id" id = "country_id" class="select2" data-allow-clear="true" data-placeholder="<?php echo get_phrase('select_country'); ?>" onchange="getCityList(this.value)" required>-->
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" name="address" rows="5" id="pac-input" class="form-control">
  </div>
</div>

<!--map placed here-->
<div id="map" draggable="true" style="height: 350px; margin-bottom: 20px;" ></div>
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control lattitude" id="lattitude" name="latitude"/>
...
<div class="form-group row mb-3">
  ...
  <div class="col-md-7">
    <input type="text" class="form-control lonngitude" id="longitude" name="longitude" />
  </div>
</div>
